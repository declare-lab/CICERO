...
def main():
    ...
    for epoch in epochs:
        ...
        for step, batch_idx in enumerate(tqdm(train_batch_idx, desc="Training...", position=1)):
            ...
            if cur_step % training_args.eval_steps == 0 and cur_step > 0:
                ...
                eval_metrics = jax.tree_utils.tree_map(jnp.mean, eval_metrics)
            ...
            if cur_step % training_args.save_steps == 0 and cur_step > 0:
                ...
                if jax.process_index() == 0:
                    params = jax.device_get(jax.tree_utils.tree_map(lambda x: x[0], state.params))
    ...
    if training_args.do_eval:
        ...
        # get eval metrics
        eval_metrics = get_metrics(eval_metrics)
        eval_metrics = jax.tree_utils.tree_map(lambda metric: jnp.mean(metric).item(), eval_metrics)
